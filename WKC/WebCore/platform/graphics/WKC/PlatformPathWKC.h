...
namespace WebCore {
    ...
    class PlatformPathWKC {
    public:
        PlatformPathWKC();
        PlatformPathWKC(const PlatformPathWKC*);
        ~PlatformPathWKC();
        const PlatformPathElements& elements() const { return m_elements; }
        void append(const PlatformPathElement& e);
        void append(const PlatformPathWKC& p);
        void clear();
        bool isEmpty() const { return m_elements.isEmpty(); }

        void strokePath(void*, const TransformationMatrix* tr) const;
        void fillPath(void*, const TransformationMatrix* tr) const;
        void clipPath(void*, const TransformationMatrix* tr) const;
