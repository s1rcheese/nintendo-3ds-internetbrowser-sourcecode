...
#if 1
    // added at webkit.org trunk r72817
...
#if 0
    // removed at webkit.org trunk r72817
...
#if PLATFORM(WKC)
            if (elapsedTime < gMinDelayBeforeLiveDecodedPrune)
#else
...
#if PLATFORM(WKC)
void Cache::deleteSharedInstance()
{
    delete gStaticCache;
}

void Cache::resetVariables()
{
    gStaticCache = 0;
    gMinDelayBeforeLiveDecodedPrune = cMinDelayBeforeLiveDecodedPrune;
}

void Cache::setMinDelayBeforeLiveDecodedPrune(double second)
{
