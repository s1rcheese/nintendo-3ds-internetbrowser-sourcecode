...
{
#if 1
    // added at webkit.org trunk r52948 and modified at r52951
...
JSGlobalData* JSDOMWindowBase::m_globalData = 0;
...
JSGlobalData* JSDOMWindowBase::commonJSGlobalData()
{
    ...
    if (!m_globalData) {
        m_globalData = JSGlobalData::createLeaked().releaseRef();
        m_globalData->timeoutChecker.setTimeoutInterval(10000); // 10 seconds
#ifndef NDEBUG
        m_globalData->mainThreadOnly = true;
#endif
        m_globalData->clientData = new WebCoreJSClientData(m_globalData);
    }
...
/* static */void JSDOMWindowBase::resetVariables()
{
    m_globalData = 0;
}

/* static */void JSDOMWindowBase::deleteSharedInstance()
{
    delete m_globalData;
    m_globalData = 0;
}

/* static */JSGlobalData* JSDOMWindowBase::jsGlobalData()
{
    return m_globalData;
}
