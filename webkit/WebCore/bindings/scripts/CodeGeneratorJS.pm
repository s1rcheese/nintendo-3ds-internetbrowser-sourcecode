...
sub GenerateHeader
{
    ...
    push(@headerContent, "\n// Reset ROM Tables\n");
    push(@headerContent, "void $className", "_resetROMTables();\n");
...
sub GenerateImplementation
{
    ...
    if ($numAttributes > 0) {
        ...
        $object->GenerateResetHashTable($hashName, \$resetROMTables);
    }
    ...
    if (length($resetROMTables) > 0) {
        push(@implContent, "\nvoid $className" , "_resetROMTables()\n{\n");
        push(@implContent, "$resetROMTables\n}\n");
    }
...
sub GenerateResetHashTable
{
    ...
    if (length($$text) == 0) {
        $$text = "    HashTable *htable;\n\n";
    } else {
        $$text = $$text . "\n";
    }

    $$text = $$text . "    htable = const_cast<HashTable*>(&" . $name . ");\n";
    $$text = $$text . "    htable->table = 0;\n";
}
