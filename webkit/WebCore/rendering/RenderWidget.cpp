...
#if 1
// added at webkit.org trunk r62271
...
#if PLATFORM(WKC)
static HashMap<const Widget*, RenderWidget*>* gStaticWidgetRendererMap = 0;

static HashMap<const Widget*, RenderWidget*>& widgetRendererMap()
{
    if (!gStaticWidgetRendererMap) {
        gStaticWidgetRendererMap = new HashMap<const Widget*, RenderWidget*>;
    }
    return *gStaticWidgetRendererMap;
}
...
static WidgetToParentMap* gMap = 0;

static WidgetToParentMap& widgetNewParentMap()
{
    if (!gMap) {
        gMap = new WidgetToParentMap();
    }
    return *gMap;
}

void RenderWidget::deleteSharedInstance()
{
    delete gStaticWidgetRendererMap;
    delete gMap;
}

void RenderWidget::resetVariables()
{
    gStaticWidgetRendererMap = 0;
    widgetHierarchyUpdateSuspendCount = 0;
    gMap = 0;
}
