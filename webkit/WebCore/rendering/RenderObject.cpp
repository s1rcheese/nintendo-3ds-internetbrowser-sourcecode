...
#ifndef NDEBUG
static WTF::RefCountedLeakCounter* renderObjectCounter;
#endif

void RenderObject::deleteSharedInstance()
{
#ifndef NDEBUG
    delete renderObjectCounter;
#endif
}

void RenderObject::resetVariables()
{
    s_affectsParentBlock = false;
#ifndef NDEBUG
    baseOfRenderObjectBeingDeleted = 0;
...
#if 1
        // modified at webkit.org trunk r56890
...
#ifndef NDEBUG
#if PLATFORM(WKC)
    if (!renderObjectCounter) {
        renderObjectCounter = new WTF::RefCountedLeakCounter("RenderObject");
    }
...
#if 1
    // modified at webkit.org trunk r53196
...
#if 1
// added at webkit.org trunk r63048
...
void RenderObject::styleWillChange(StyleDifference diff, const RenderStyle* newStyle)
{
    ...
    if (view()->frameView()) {
#if 0
        // removed at webkit.org trunk r55890
        // FIXME: A better solution would be to only invalidate the fixed regions when scrolling.  It's overkill to
        // prevent the entire view from blitting on a scroll.
#endif
        bool shouldBlitOnFixedBackgroundImage = false;
#if ENABLE(FAST_MOBILE_SCROLLING)// Patch of https://bugs.webkit.org/show_bug.cgi?id=33408
...
#if 1
        // modified at webkit.org trunk r55890, r57165, r61686.
...
#if 1
// needed for changes of webkit.org trunk r54521
...
#if 1
        // added at webkit.org trunk r54521
