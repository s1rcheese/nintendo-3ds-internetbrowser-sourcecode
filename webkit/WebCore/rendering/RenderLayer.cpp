...
#if PLATFORM(WKC)
static RefPtr<Image>* resizeCornerImage = 0;
#endif
...
void RenderLayer::paintResizer(GraphicsContext* context, int tx, int ty, const IntRect& damageRect)
{
    ...
    if (!resizeCornerImage) {
        resizeCornerImage = new RefPtr<Image>(Image::loadPlatformResource("textAreaResizeCorner"));
    }
...
#if 1
    // added at webkit.org trunk r57759, r57817
...
#if 1
            // modified at webkit.org trunk r57759
...
#if PLATFORM(WKC)
void RenderLayer::deleteSharedInstance()
{
    delete resizeCornerImage;
}

void RenderLayer::resetVariables()
{
    previousMousePosition = IntPoint();
    resizeCornerImage = 0;
}
#endif
