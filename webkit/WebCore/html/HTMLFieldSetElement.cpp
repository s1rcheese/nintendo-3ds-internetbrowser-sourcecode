...
#if PLATFORM(WKC)
static AtomicString* gFieldset = 0;
const AtomicString& HTMLFieldSetElement::formControlType() const
{
    if (!gFieldset) {
        gFieldset = new AtomicString("fieldset");
    }
    return *gFieldset;
}
#else
...
#if PLATFORM(WKC)
void HTMLFieldSetElement::deleteSharedInstance()
{
    delete gFieldset;
}

void HTMLFieldSetElement::resetVariables()
{
    gFieldset = 0;
}
#endif
