...
#if 1
    // added at webkit.org trunk r55890
...
#if 1
    // modified at webkit.org trunk r63138
...
#if PLATFORM(WKC)
    if (!subtree && m_canHaveScrollbars) {
#else
    if (!subtree) {
#endif
...
{
#if 1
    // modified at webkit.org trunk r55890
...
#if 1
// added at webkit.org trunk r55890, and then modified r57165, r61686
...
// Instead of 'ListHashSet<RenderBox*>', 'RenderBlock::PositionedObjectsListHashSet' is used at r61686. It was typedef'ed at r59678.
...
#if PLATFORM(WKC)
void FrameView::resetVariables()
{
    sCurrentPaintTimeStamp = 0.0;
}
#endif
