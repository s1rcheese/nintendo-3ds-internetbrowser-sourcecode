...
#ifndef NDEBUG
#if PLATFORM(WKC)
static WTF::RefCountedLeakCounter* gRangeCounter = 0;
#else
...
#if PLATFORM(WKC)
    if (!gRangeCounter) {
        gRangeCounter = new WTF::RefCountedLeakCounter("Range");
    }
    WTF::RefCountedLeakCounter& rangeCounter = *gRangeCounter;
#endif
...
#if PLATFORM(WKC)
void Range::deleteSharedInstance()
{
#ifndef NDEBUG
    delete gRangeCounter;
#endif
}

void Range::resetVariables()
{
#ifndef NDEBUG
    gRangeCounter = 0;
#endif
