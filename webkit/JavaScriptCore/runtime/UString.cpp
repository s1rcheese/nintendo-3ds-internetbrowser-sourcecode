...
#if PLATFORM(WKC)
void deleteUStringSharedInstance()
{
    delete UStringImpl::s_null;
    delete UStringImpl::s_empty;
    delete UString::nullUString;
}

void resetUStringVariables()
{
    sharedEmptyChar = 0;
    UStringImpl::s_null = 0;
    UStringImpl::s_empty = 0;
    UString::nullUString = 0;
}
#endif
...
#if PLATFORM(WKC)
static char* gAsciiBuffer = 0;

void UString::deleteSharedInstance()
{
    delete[] gAsciiBuffer;
}

void UString::resetVariables()
{
    gAsciiBuffer = 0;
...
char* UString::ascii() const
{
    ...
    int neededSize = length + 1;
    delete[] gAsciiBuffer;
    gAsciiBuffer = new char[neededSize];
