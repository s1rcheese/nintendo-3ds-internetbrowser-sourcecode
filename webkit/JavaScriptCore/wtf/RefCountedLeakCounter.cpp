...
#if PLATFORM(WKC)
/* static */ void RefCountedLeakCounter::deleteSharedInstance() { }
/* static */ void RefCountedLeakCounter::resetVariables() { }
#endif
...
/* static */ void RefCountedLeakCounter::deleteSharedInstance()
{
    delete leakMessageSuppressionReasons;
}

/* static */ void RefCountedLeakCounter::resetVariables()
{
    leakMessageSuppressionReasons = 0;
}
#endif
